...
public class UserServiceImpl implements UserService{
    ...
    @Override
    public User loadUserByUsername(String username) { return this.userRepository.findByUsername(username).orElseThrow(InvalidUsernameOrPasswordException::new); }
    ...
    public User register(String username, String password, String repeatPassword, String email) {
        ...
        User user = new User(username,passwordEncoder.encode(password), email,Role.ROLE_USER);
